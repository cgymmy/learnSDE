\chapter{Generative Model}\label{cap2}
...
In particular, $X_1 \sim p_{\text{data}}$ for this ODE, so that we might say 
...
In the next section, we will discuss how to train the model.
...
\subsection{Score Matching Diffusion}
